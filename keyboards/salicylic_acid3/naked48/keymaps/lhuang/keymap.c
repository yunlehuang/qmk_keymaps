...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WIN] = LAYOUT(
    ...
    KC_LCTL,	KC_Z,	    KC_X,	    KC_C,	    KC_V,	    KC_B,                               KC_N,   	KC_M,	    KC_COMM,	KC_DOT,	    KC_SLSH,	MUS_STG,
                _______,    ALT_NUM,	SYMBOL,	    KC_LSFT,    _______,	_______,	_______,	_______,    KC_SPC,	    NAVIGA, 	ESC_MOU,    _______
  ),
  ...
  [_TTS] = LAYOUT(
     ...
     _______,	_______,	_______,	_______,	_______,	_______,                            _______,	_______,	_______,	_______,	_______,	_______,
     _______,	_______,	_______,	_______,	_______,	_______,                            _______,	_______,	_______,	_______,	_______,	_______,
                _______,    _______,	KC_SPC,     KC_LSFT,    _______,	_______,	_______,	_______,    _______,	_______,	KC_ENT,     _______
  ),
  ...
  [_SYM] = LAYOUT(
     ...
     _______,	KC_WH_D,	KC_WH_U,	KC_LABK,	KC_RABK,	XXXXXXX,                            XXXXXXX,	KC_LCBR,	KC_RCBR,	XXXXXXX,	XXXXXXX,	_______,
                _______,    CTR_LEF,	XXXXXXX,	CTR_RIG,    _______,	_______,	_______,	_______,    _______,	XXXXXXX,	_______,    _______
  ),
  ...
  [_NAV] = LAYOUT(
     ...
     _______,	_______,	KC_WH_L,	KC_BTN3,	KC_WH_R,	_______,                            _______,	WRDPREV,	XXXXXXX,	WRDNEXT,	_______,	_______,
                _______,    KC_ACL0,	KC_ACL1,	KC_ACL2,    _______,	_______,	_______,	_______,    _______,	XXXXXXX,	_______,    _______
  ),
  ...
  [_NUM] = LAYOUT(
     ...
     _______,	KC_F9,	    KC_F10,	    KC_F11,	    KC_F12,	    _______,                            KC_PMNS,	KC_1,	    KC_2,	    KC_3,   	XXXXXXX,	_______,
                _______,    _______,	_______,	_______,    _______,	_______,	_______,	_______,    KC_PPLS,	KC_0,	    KC_DOT,     _______
  ),
  ...
  [_GAM] = LAYOUT(
     ...
     KC_4,	    KC_LALT,	KC_Z,	    KC_X,   	KC_C,   	KC_V,                               KC_N,   	KC_M,   	KC_COMM,	KC_DOT,	    KC_SLSH,	MUS_STG,
                _______,    KC_LCTL,	KC_SPC,	    KC_1,       _______,	_______,	_______,	_______,    KC_SPC,	    KC_ESC,	    TO(_WIN),   _______
  ),
  ...
  [_MUS] = LAYOUT(
     ...
     RESET,	    _______,	RGB_RMOD,   RGB_MOD,	RGB_TOG,	_______,                            TO(_JIG),   KC_MUTE,	KC_VOLD,	KC_VOLU,	_______,	XXXXXXX,
                _______,    DEBUG,	    _______,	_______,    _______,	_______,	_______,	_______,    TO(_WIN),   TO(_TTS),   TO(_GAM),   _______
  )
};
